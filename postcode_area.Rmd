...
2. Load a dataset
3. Join the aggregated dataset to the polgyons
4. Visualise
...
For this project we are going to use the UK Postcode Areas.  The boundary files are in geojson format and can be found in the data folder.
...
For this project we are going to use a sample dataset.
